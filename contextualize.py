...
def main(dataset_path, temp_dir):
    ...
    df = pickle.load(open(pkl_dump_dir + "df_trans.pkl", "rb"))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default='./data/nyt/fine/trans3/')
    parser.add_argument('--temp_dir', type=str, default='/tmp/nyt_fine/trans3/')
