...
def index(labels, C):
    ...
    for label in labels:
        # if label == "soc":
        #     train_mul_C.append(C[0])
        # if label == "talk":
        #     train_mul_C.append(C[1])
        # if label == "rec":
        #     train_mul_C.append(C[2])
        # if label == "sci":
        #     train_mul_C.append(C[3])
        # if label == "comp":
        #     train_mul_C.append(C[4])
        # if label == "misc":
        #     train_mul_C.append(C[5])
        # if label == "alt":
        #     train_mul_C.append(C[6])
##############nyt-fine###################
        # if label == "football":
        #     train_mul_C.append(C[0])
        ...
        #     train_mul_C.append(C[7])
        # if label == "basketball":
        #     train_mul_C.append(C[8])
        # if label == "soccer":
        #     train_mul_C.append(C[9])
        # if label == "surveillance":
        #     train_mul_C.append(C[10])
        # if label == "economy":
        #     train_mul_C.append(C[11])
        # if label == "tennis":
        #     train_mul_C.append(C[12])
        # if label == "military":
        #     train_mul_C.append(C[13])
        # if label == "golf":
        #     train_mul_C.append(C[14])
        # if label == "music":
        #     train_mul_C.append(C[15])
        # if label == "abortion":
        #     train_mul_C.append(C[16])
        # if label == "gay_rights":
        #     train_mul_C.append(C[17])
        # if label == "television":
        #     train_mul_C.append(C[18])
        # if label == "dance":
        #     train_mul_C.append(C[19])
        # if label == "movies":
        #     train_mul_C.append(C[20])
        # if label == "gun_control":
        #     train_mul_C.append(C[21])
        # if label == "baseball":
        #     train_mul_C.append(C[22])
        # if label == "environment":
        #     train_mul_C.append(C[23])
        # if label == "the_affordable_care_act":
        #     train_mul_C.append(C[24])
        # if label == "hockey":
        #     train_mul_C.append(C[25])
###################nyt-coarse##################
        if label == "sports":
            train_mul_C.append(C[2])
        if label == "politics":
...
def create_train_dev(texts, labels, tokenizer, max_sentences=15, max_sentence_length=100, max_words=200000):
    data = prep_data(max_sentence_length, max_sentences, texts, tokenizer)
    #X_train, X_test, y_train, y_test = train_test_split(data, labels, train_size=7424,  random_state=42)
